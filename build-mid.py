#!/usr/bin/env python3
"""Собирает среднюю версию портала в один файл EpiPrint_mid.html."""
import re, pathlib

base = pathlib.Path(__file__).parent
css     = (base/"assets/style-mid.css").read_text(encoding="utf-8")
...
portal  = (base/"assets/portal-mid.js").read_text(encoding="utf-8")
